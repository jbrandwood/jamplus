...
[
    ...
    [ "rule DependsUnique targets1 : targets2 [ : target3 ... targets9 ] ;", "builtin_rules.html#rule_DependsUnique", null ],
    [ "rule Includes targets1 : targets2 [ : target3 ... targets9 ] ;", "builtin_rules.html#rule_Includes", null ],
    [ "rule IncludesUnique targets1 : targets2 [ : target3 ... targets9 ] ;", "builtin_rules.html#rule_IncludesUnique", null ],
    [ "rule Needs targets1 : targets2 [ : target3 ... targets9 ] ;", "builtin_rules.html#rule_Needs", null ],
    [ "rule NeedsUnique targets1 : targets2 [ : target3 ... targets9 ] ;", "builtin_rules.html#rule_NeedsUnique", null ],
    ...
    [ "rule AliasTarget ALIAS_TARGET_NAMES : DESTINATION_TARGET", "builtin_rules.html#rule_AliasTarget", null ],
    ...
    [ "rule CompareFileTimestamp LEFT_TARGET : RIGHT_TARGET", "builtin_rules.html#rule_CompareFileTimestamp", null ],
    ...
    [ "rule Echo ARGS [ : ARGS2 : ARGS3 ] ;", "builtin_rules.html#rule_Echo", null ],
    [ "rule Exit ARGS [ : ARGS2 : ARGS3 ] ;", "builtin_rules.html#rule_Exit", null ],
    [ "rule ExpandFileList WILDCARDS : ABSOLUTE : THIS_SEARCH_SOURCE", "builtin_rules.html#rule_ExpandFileList", null ],
    ...
    [ "rule ListAppendUnique LIST : APPEND_LIST ;", "builtin_rules.html#rule_ListAppendUnique", null ],
    [ "rule ListLength LIST ;", "builtin_rules.html#rule_ListLength", null ],
    ...
    [ "rule_RescanTimestamp TARGET ;", "builtin_rules.html#rule_RescanTimestamp", null ],
