rm -rf ../bin/linux32
mkdir -p ../bin/linux32
gcc -c -DLUA_USE_LINUX -g -O2 -fomit-frame-pointer -m32 -Wno-old-style-definition -Wno-parentheses -Wno-unused-result -Wno-stringop-overflow -I luaplus/Src/LuaPlus/lua53-luaplus/src -I luaplus/Src -pthread onejam.c onejam-luaexpat.c
