...
static int pmain (lua_State *L) {
  ...
  int ls_pmain(struct ls_lua_State *L);
  ls_pmain((struct ls_lua_State *)L);
  void ls_register_custom_libs(struct ls_lua_State* L);
  ls_register_custom_libs((struct ls_lua_State *)L);
